      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-6">
        {live ? (
          <div className="flex flex-col items-center gap-3">
            <span className="tag tag-accent uppercase tracking-wider">On air</span>
            <div className="levels h-10">
              {[0.62, 0.48, 0.72, 0.54, 0.66].map((d, i) => (
                <span key={i} style={{ height: 40, animationDuration: `${d}s` }} />
              ))}
            </div>
            <div className="text-sm text-neutral-400">They can hear you</div>
          </div>
        ) : (
        ...
        <div className="text-xs text-neutral-600">Release to close the channel</div>
      </div>
